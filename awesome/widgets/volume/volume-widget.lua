...
-- https://github.com/streetturtle/widgets/tree/master/volume
...
local icon_widget = require("widgets.volume.icon-variant")
...
local function worker(user_args)
    ...
    volume.widget = icon_widget.get_widget(args.icon_args)
